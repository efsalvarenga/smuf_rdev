...
crossvalstps  = 2                       # Step used for multiple crossvalidation
...
fx_rndgrp <- function(wm01,frontierstp,sampling){
...
#===========================================
# Run for individual customers
#===========================================
wm01_01    = wm01_00[min(cus_list):length(cus_list),]
wl06       = fx_int_cvfcst(wm01_01,h,in_sample_fr,s01,s02,sum_of_h,win_size,seas_bloc_ws,crossvalsize)
wv45       = rowMeans(wl06[[1]])
sd01       = as.numeric(fx_sd_mymat(wl06[[3]]))

#===========================================
# Run for random groups
#===========================================
wm01_02l   = fx_rndgrp(wm01_01,frontierstp,sampling)
wm01_02    = wm01_02l[[1]] / rowSums(wm01_02l[[2]])
wl06rnd    = fx_int_cvfcst(wm01_02,h,in_sample_fr,s01,s02,sum_of_h,win_size,seas_bloc_ws,crossvalsize)
