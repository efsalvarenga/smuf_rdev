...
cus_list      <- seq(1,1000)
frontierstp   <- stepwiseHPC*2           # Number of demand bins (Stepwise frontier for portfolio optimisation)
...
hrz_lim       <- seq(7,17)*113            # Rolling forecasts steps {seq(0:167)*113} is comprehensive
