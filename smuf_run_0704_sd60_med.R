...
savfile = "smuf_run_0704_sd60_med.rds"
...
hrz_lim       <- c(0)*113            # Rolling forecasts steps {seq(0:167)*113} is comprehensive
...
crossvalfocus <- c(60)                  # What period is focused when running crossvalidation
