...
savfile = "smuf_runf_1121_KO_all-04h_ws04_rlx.rds"
...
for (h in hrz_lim){
  ...
  res_sdrlx    <- fx_applgrp(optgrp_sdrlx,wv46,wm01_01,fx_int_fcstgeneric_armagarch,h,in_sample_fr,s01,s02,sum_of_h,win_size,is_wins_weeks,crossvalsize,armalags,cross_overh,crossvalfocus)
