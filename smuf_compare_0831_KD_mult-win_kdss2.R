...
for (h in hrz_lim){
  ...
  cat("KD04 ")
  wl06kdWS04  <- fx_int_fcstgeneric_kdss2(wm01_01,h,in_sample_fr,s01,s02,sum_of_h,win_size[1],is_wins_weeks,crossvalsize,T,armalags,cross_overh,gof.min)
  cat("KD06 ")
  wl06kdWS06  <- fx_int_fcstgeneric_kdss2(wm01_01,h,in_sample_fr,s01,s02,sum_of_h,win_size[1],is_wins_weeks,crossvalsize,T,armalags,cross_overh,gof.min)
  cat("KD12 ")
  wl06kdWS12  <- fx_int_fcstgeneric_kdss2(wm01_01,h,in_sample_fr,s01,s02,sum_of_h,win_size[1],is_wins_weeks,crossvalsize,T,armalags,cross_overh,gof.min)
  cat("KD24 ")
  wl06kdWS24  <- fx_int_fcstgeneric_kdss2(wm01_01,h,in_sample_fr,s01,s02,sum_of_h,win_size[2],is_wins_weeks,crossvalsize,T,armalags,cross_overh,gof.min)
  cat("KD48 ")
  wl06kdWS48  <- fx_int_fcstgeneric_kdss2(wm01_01,h,in_sample_fr,s01,s02,sum_of_h,win_size[2],is_wins_weeks,crossvalsize,T,armalags,cross_overh,gof.min)
  cat(" [Consolidating]\n")
