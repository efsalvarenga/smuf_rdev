...
savfile = "smuf_compare_0825_KDxAG_large_mult-gofmin.rds"
...
hrz_lim       <- seq(1:500)*37            # Rolling forecasts steps {seq(0:167)*113} is comprehensive
...
for (h in hrz_lim){
  ...
  reslis.h[[5]] <- rbind(reslis.h[[5]],colMeans(wl06ag0.50[[2]],na.rm=T))
  resmat.h  <- matrix(nrow=0,ncol=max(ahead_t))
