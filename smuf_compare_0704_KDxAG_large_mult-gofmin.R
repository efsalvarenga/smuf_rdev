...
hrz_lim       <- seq(21,40)*113            # Rolling forecasts steps {seq(0:167)*113} is comprehensive
...
for (h in hrz_lim){
  ...
  rownames(resmat.h) <- c(paste("KD",1:2),"AG0.20","AG0.05","AG0.01","AG0.00")
  plt.names <- rownames(resmat.h)
  fx_plt_mymat(resmat.h,c(0.05,0.15))
